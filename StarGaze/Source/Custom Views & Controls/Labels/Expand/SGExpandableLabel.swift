//
//  SGExpandableLabel.swift
//  StarGaze
//
//  Created by Suraj Shetty on 12/05/22.
...
class SGExpandableLabel: ActiveLabel {
    ...
    var textReplacementType: TextReplacementType = .word
    ...
    func setText(_ text:String) {
        let attributedText = NSAttributedString(string: text)
            .copyWithAddedFontAttribute(font)
            .copyWithParagraphAttribute(font)
    ...
    func setLessLinkWith(lessLink: String, attributes: [NSAttributedString.Key: AnyObject], position: NSTextAlignment?) {
...
private extension SGExpandableLabel {
